...
void SegmentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SegmentDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SegmentDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_SegmentDialog.data,
    qt_meta_data_SegmentDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SegmentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::SegSelectDialog"))
        return static_cast< Ui::SegSelectDialog*>(this);
